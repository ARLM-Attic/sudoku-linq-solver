    ...
    public class UndoRedoControler
    {
        ...
        protected internal virtual string ToolTipText
        {
            ...
            set
            {
                if (m_has_tool_tip_text)
                {
                    if (UndoRedoConfiguration.UndoRedo_ModifyTooltips)
                    {
        ...
        internal Func<UndoRedoAction, string> GetDescription;
        internal Func<IEnumerable<UndoRedoAction>> GetSubList;
        internal Action<UndoRedoAction> Action;
    }
}
